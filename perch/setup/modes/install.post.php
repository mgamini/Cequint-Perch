    ...
    if (defined('PERCH_DB_PREFIX')) {
        ...
        if (PerchUtil::count($queries) > 0) {
            ...
            if ($db_fail) {
                ...
                echo 'If you\'re still have trouble, it\'s possible that the MySQL user hasn\'t got enough access rights to create tables. Either change this, if you can, or run the following SQL code via a control panel (such as PhpMyAdmin) if you have one. <a href="index.php?install=1">Then reload this page</a>.</p>';
